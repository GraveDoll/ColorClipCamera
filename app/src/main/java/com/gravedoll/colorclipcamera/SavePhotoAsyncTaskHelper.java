...
/**
 * Created by GraveDoll on 2014/10/12.
 */
public class SavePhotoAsyncTaskHelper extends AsyncTaskLoader<File> {
    ...
    public SavePhotoAsyncTaskHelper(Context context, Mat mat, int degree) {
        super(context);
    ...
    public File loadInBackground() {
        ...
        String mFilename = "pht" + String.valueOf(System.currentTimeMillis()) + ".jpg";
        String date = String.valueOf(System.currentTimeMillis());
        String attachName = mDirectory + "/" + mFilename;
        file = new File(attachName);
        try {
